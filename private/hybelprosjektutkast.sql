...
--
-- Database: `hybelprosjektutkast`
--
CREATE DATABASE IF NOT EXISTS `hybelprosjektutkast` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `hybelprosjektutkast`;
...
CREATE TABLE `advert` (
  ...
  `ad_residence_type` int(11) NOT NULL,
  `ad_desc` varchar(1700) NOT NULL,
...
CREATE TABLE `city` (
  ...
  `zip_location` varchar(20) DEFAULT NULL
...
INSERT INTO `city` (`zip_code`, `zip_location`) VALUES
('0001', 'OSLO'),
('0010', 'OSLO'),
('0015', 'OSLO'),
('0018', 'OSLO'),
...
CREATE TABLE `residence_type` (
  ...
  `residence_type_name` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
ALTER TABLE `advert`
  ...
  ADD KEY `fk_ad_user` (`ad_user_id`),
  ADD KEY `fk_ad_residence_type` (`ad_residence_type`);

--
-- Indexes for table `residence_type`
--
ALTER TABLE `residence_type`
  ADD PRIMARY KEY (`residence_type_id`);
...
--
ALTER TABLE `residence_type`
  MODIFY `residence_type_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `advert`
  ADD CONSTRAINT `fk_ad_residence_type` FOREIGN KEY (`ad_residence_type`) REFERENCES `residence_type` (`residence_type_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_ad_user` FOREIGN KEY (`ad_user_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
